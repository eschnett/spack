...
compiler='gcc@7.3.0-spack'
if [ $(uname) = Darwin ]; then
    compiler1='clang@9.0.0'
else
    compiler1="$compiler"
fi
...
spack view -d false hardlink -i "../spack-tmux" rsync
...
spack view -d false hardlink -i "../spack-view" gcc@7.3.0 # %"$compiler1"
