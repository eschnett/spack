...
spack view -d false hardlink "../spack-tmux" lmod%gcc@7.1.0-spack
spack view -d false hardlink "../spack-tmux" rsync%gcc@7.1.0-spack
spack view -d false hardlink "../spack-tmux" tmux%gcc@7.1.0-spack

mv "../spack-view.old" "../spack-view" 2>/dev/null || true;
mv "../spack-view" "../spack-view.old" 2>/dev/null || true;

spack view -d true hardlink "../spack-view" cactusext%gcc@7.1.0-spack
spack view -d true hardlink "../spack-view" gcc@7.1.0

easy_install_file="../spack-view/lib/python2.7/site-packages/easy-install.pth"
rm -f "$easy_install_file"
for pkg in $(spack find -d -l cactusext%gcc@7.1.0-spack |
